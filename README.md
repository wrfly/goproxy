...
[![GoDoc](https://godoc.org/github.com/wrfly/goproxy?status.svg)](https://godoc.org/github.com/wrfly/goproxy)
[![Join the chat at https://gitter.im/wrfly/goproxy](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/wrfly/goproxy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
Get the latest goproxy from `gopkg.in/wrfly/goproxy.v1`.
...
[the eavesdropper example](https://github.com/wrfly/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2.  Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/wrfly/goproxy/tree/master/examples/goproxy-transparent)
