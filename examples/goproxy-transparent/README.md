...
Example routing rules are included in [proxy.sh](https://github.com/wrfly/goproxy/blob/master/examples/goproxy-transparent/proxy.sh) but are best when setup using your distribution's configuration.
